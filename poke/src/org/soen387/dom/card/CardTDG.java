...
public class CardTDG {
	...
	private static final String INSERT = "INSERT INTO " + CardTDG.TABLE + " (id, version, deck_id, type, name) VALUES (?, ?, ?, ?, ?)";
	private static final String UPDATE = "UPDATE " + CardTDG.TABLE + " SET version=version+1, type=?, name=? WHERE id=? AND version=?";
	...
	public static int insert(Long id, long version, long deckId, String type, String name) throws SQLException {
